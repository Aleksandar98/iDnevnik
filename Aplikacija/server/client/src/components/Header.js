...
class Header extends Component{
    ...
    renderContent(){
      ...
      if(this.props.response === false){
        return <li><a href="/login"><span className="glyphicon glyphicon-log-in"></span> Login</a></li>
      ...
      return <li><a href="http://localhost:5000/logout"><span className="glyphicon glyphicon-log-out"></span> Logout</a></li>
    ...
    render(){
        ...
        <div className="container-fluid">
            <div className="navbar-header">
                ...
                <a className="navbar-brand" href="/">iDnevnik</a>
            </div>
            <div className="collapse navbar-collapse" id="myNavbar">
                <ul className="nav navbar-nav ">
                    <li><a href="/Ocene" title="Ocene">OCENE</a></li>
