...
class InfoiKontakt extends Component {
   ...
   componentDidMount () {
    ...
    getRoditelj() {
        ...
        else if (this.props.infoKorisnika.username != null && this.props.infoKorisnika.type == "roditelj")
        {
        ...
        {
            axios.post('http://localhost:5000/profesori/vratiProfesora', {email: this.props.infoKorisnika.username})
    ...
    render() {
        ...
        if (this.props.infoKorisnika.type == "ucenik" && this.state.idDeteta == "staro")
            return <h3>Loading1...</h3>
        else if (this.props.infoKorisnika.type == "roditelj" && this.state.rod == "staro")
            return <h3>Loading2...</h3>
        else if (this.props.infoKorisnika.type == "profesor" && this.state.profa == "staro")
        ...
        else if (this.props.infoKorisnika.type == "profesor")
        {
            ...
            informacije.push(React.createElement("h5", null,"Prezime: " +prof.prezime));
            informacije.push(React.createElement("h5", null,"Email: " + prof.email));
            informacije.push(React.createElement("h5", null, "Predmet: " + prof.predmet));
            pol = prof.pol;
        }
                ...
                {this.state.profa == 'staro' ? null :
                                ...
                                <div className="container-fluid">
                                  <div className="navbar-header">
                                    ...
                                    <a className="navbar-brand" href="/preview">ADULINX SOFT</a>
                                  </div>
