    ...
    render() {
        return (
            <div className="container MT ">
                ...
                <form className="form-horizontal" method='POST' action="http://localhost:5000/resetpass">
                    ...
                    <div className="form-group">
                        <label className="control-label col-sm-2" >Nova Lozinka:</label>
                        <div className="col-sm-10">
                            <input type="password" className="form-control" placeholder="Unesite novu lozinku" name="pass" />
                        </div>
                    </div>
                    ...
                    <div className="form-group">
                        <label className="control-label col-sm-2" >Potvrda lozinke:</label>
                        <div className="col-sm-10">
                            <input type="password" className="form-control" placeholder="Potvrdite novu lozinku" name="passconf" onChange={this.check} />
                        </div>
                    </div>
                    <div className="form-group">
                        <div className="col-sm-offset-2 col-sm-10">
