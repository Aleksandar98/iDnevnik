            ...
            <div>
                <BrowserRouter>
                    <div>
                        ...
                        {this.state.response.type=="ucenik" || this.state.response.type=="roditelj" ? <Header ucenik={this.state.ucenik} response={this.state.response} /> : null}
                        ...
                        <Route exact path="/Forum" render={(props) => <Forum {...props}  infoKorisnika ={this.state.response} />} />
                        <Route exact path="/Izostanci" render={(props) => <Izostanci {...props}  infoKorisnika ={this.state.response} />}/>
                        <Route exact path="/Vladanje"  render={(props) => <Vladanje {...props}  infoKorisnika ={this.state.response} />}/>
                        <Route exact path="/Raspored" render={(props) => <Raspored {...props}  infoKorisnika ={this.state.response} />} />
                        <Route exact path="/Dogadjaji" render={(props) => <Dogadjaji {...props}  infoKorisnika ={this.state.response} />} />
                        <Route exact path="/Ocene" render={(props) => <Ocene {...props}  infoKorisnika ={this.state.response} />} />
                        <Route exact path="/PromenaLozinke" component={PromenaLozinke}/>
                        <Route exact path="/InfoiKontakt" render={(props) => <InfoiKontakt {...props}  infoKorisnika ={this.state.response} />} />
