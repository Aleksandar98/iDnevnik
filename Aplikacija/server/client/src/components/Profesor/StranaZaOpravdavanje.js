...
export default class StranaZaOpravdavanje extends Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:5000/profesori/Profesor/'+this.state.id_profesora)
        .then(res => {
    ...
    opravdaj(id, dat, tip1, idzahteva) {
        ...
        axios.post('http://localhost:5000/profesori/odlukaOpravdanja', zaSlanje)
        .then(res => {  
        ...
        // console.log(objekat)
        axios.post('http://localhost:5000/profesori/brisemIzostanak',objekat)
        .then(res => {  
                    ...
                    <tbody>
                        {zahtevi.map(zahtev => {
                            return  <tr>
                                        ...
                                        <td><button className="btn-success" onClick={() => this.opravdaj(zahtev.DeteId, zahtev.Datum, 'Opravdani',zahtev._id)}>Opravdaj</button></td>
                                        <td><button className="btn-danger" onClick={() => this.neopravdaj(zahtev.DeteId, zahtev.Datum, 'Neopravdani',zahtev._id)}>Neopravdaj</button></td>
                                    </tr>
                        })}
